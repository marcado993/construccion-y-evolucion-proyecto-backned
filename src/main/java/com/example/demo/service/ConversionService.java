...
public class ConversionService {
     ...
     */
    public ConversionResponse convertir(ConversionRequest request, User user, boolean guardar, boolean espejo) {
        String resultado;
        boolean exito = true;
        ...
        try {
            if ("texto-a-braille".equals(request.getTipo())) {
                resultado = brailleService.textoABraille(request.getTexto(), espejo);
